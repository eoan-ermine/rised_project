-- "addons\\rised_ration\\lua\\weapons\\weapon_ration3\\shared.lua"
...
function SWEP:PrimaryAttack()
	if SERVER then
		if self.Owner:getDarkRPVar("Energy") <= 75 then
		...
		-- Настроение --
		hook.Call("playerMoodChanged", GAMEMODE, self.Owner, -2)
		
		if bool == true then
			self.Owner:SetHealth(self.Owner:Health() - math.random(3,8))
