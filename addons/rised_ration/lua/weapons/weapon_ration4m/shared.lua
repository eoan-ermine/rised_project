-- "addons\\rised_ration\\lua\\weapons\\weapon_ration4m\\shared.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
if SERVER then
    AddCSLuaFile("shared.lua")
end

SWEP.PrintName = "Рацион метрокопа"
SWEP.Author = "D-Rised"
SWEP.Slot = 4
SWEP.SlotPos = 10
...
SWEP.ViewModel = "models/weapons/w_packatm.mdl"
...
function SWEP:PrimaryAttack()
	if SERVER then
		if self.Owner:getDarkRPVar("Energy") <= 85 then
			self.Owner:setDarkRPVar("Energy", self.Owner:getDarkRPVar("Energy") + 35)
		...
		if bool == true then
			self.Owner:SetHealth(self.Owner:Health() - math.random(10,20))
