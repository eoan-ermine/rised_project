-- "addons\\cityclocks\\lua\\entities\\city_digitalclock\\cl_init.lua"
...
function ENT:Draw()
	...
	cam.Start3D2D(self:LocalToWorld(Vector(1,-6.75,6.64)),self:LocalToWorldAngles(Angle(0,90,90)),0.07)
		...
		draw.DrawText(GetGlobalString("HoursTimeString") .. ":" .. GetGlobalString("MinutsTimeString"),"SkyFox-DigitalClock2",96.5,0,self:GetColor(),1)
	cam.End3D2D()
end