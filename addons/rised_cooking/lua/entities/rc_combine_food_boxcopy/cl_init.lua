-- "addons\\rised_cooking\\lua\\entities\\rc_combine_food_boxcopy\\cl_init.lua"
...
function ENT:Draw()
	...
	cam.Start3D2D(position, angle, 0.1)
		...
		draw.SimpleTextOutlined("А л ь я н с", "marske4" ,0,(k*25-30), Color(255,255,255,255), 1, 1, 0.5, Color(0,0,0,255))
