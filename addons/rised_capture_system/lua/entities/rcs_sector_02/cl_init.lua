-- "addons\\rised_capture_system\\lua\\entities\\rcs_sector_02\\cl_init.lua"
	...
	if LocalPlayer():GetPos():Distance(self:GetPos()) < 500 then
		...
		if rebelValue > 0 then
			cam.Start3D2D(pos+ang:Up()*19, ang, 0.12)
					...
					draw.SimpleTextOutlined(math.Round((rebelValue*100)/100).."%", "TargetIDSmall", 0, -402, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(25, 25, 25, 0));
