-- "addons\\darkrpmodification\\lua\\weapons\\weapon_cs_base2\\shared.lua"
...
function SWEP:DrawWeaponSelection(x, y, wide, tall, alpha)
    if self.IconLetter then
        draw.DrawNonParsedSimpleText(self.IconLetter, "HL2MPTypeDeath", x + wide / 2, y + tall * 0.2, Color(255, 210, 0, 255), TEXT_ALIGN_CENTER)

        -- try to fool them into thinking they're playing a Tony Hawks game
        draw.DrawNonParsedSimpleText(self.IconLetter, "HL2MPTypeDeath", x + wide / 2 + math.Rand(-4, 4), y + tall * 0.2 + math.Rand(-14, 14), Color(255, 210, 0, math.Rand(10, 120)), TEXT_ALIGN_CENTER)
        draw.DrawNonParsedSimpleText(self.IconLetter, "HL2MPTypeDeath", x + wide / 2 + math.Rand(-4, 4), y + tall * 0.2 + math.Rand(-9, 9), Color(255, 210, 0, math.Rand(10, 120)), TEXT_ALIGN_CENTER)
    else
