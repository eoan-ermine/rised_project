-- "addons\\darkrpmodification\\lua\\weapons\\weapon_registration\\shared.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal

AddCSLuaFile()

if CLIENT then
SWEP.PrintName			= "Регистрация"			
SWEP.Slot				= 2
SWEP.SlotPos			= 20
...
SWEP.Author		= "D-Rised"
SWEP.Contact		= ""
SWEP.Purpose		= "Левый клик - уволить."
SWEP.Instructions	= ""
...
function SWEP:PrimaryAttack()	
	if SERVER then
		...
		if trEntity:IsPlayer() then
			trEntity:SetNWBool("IDCardRegistered", true)
		end
