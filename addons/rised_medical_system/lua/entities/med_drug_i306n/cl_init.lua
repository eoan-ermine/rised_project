-- "addons\\rised_medical_system\\lua\\entities\\med_drug_i306n\\cl_init.lua"
...
function ENT:Draw()
	...
	local mainColor = Color(0,0,0, 255);
	...
	if LocalPlayer():GetPos():Distance(self:GetPos()) < self:GetNWInt("distance") then
		cam.Start3D2D(pos+ang:Up()*3.3, ang, 0.035)
			draw.SimpleTextOutlined("I306N", "methFont", -25, -8, Color(255, 255, 255, 200), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(25, 25, 25, 100));
