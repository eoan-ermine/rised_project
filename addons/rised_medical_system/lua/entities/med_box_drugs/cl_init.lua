-- "addons\\rised_medical_system\\lua\\entities\\med_box_drugs\\cl_init.lua"
...
function ENT:Draw()
	...
	cam.Start3D2D(position, angle, 0.1)
		...
		draw.SimpleTextOutlined("Л е к а р с т в а", "marske4" ,0,(k*25-30), Color(255,255,255,255), 1, 1, 0.5, Color(0,0,0,255))
