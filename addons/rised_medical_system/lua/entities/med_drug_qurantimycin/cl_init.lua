-- "addons\\rised_medical_system\\lua\\entities\\med_drug_qurantimycin\\cl_init.lua"
...
function ENT:Draw()
	...
	local mainColor = Color(65,105,225, 255);
	...
	if LocalPlayer():GetPos():Distance(self:GetPos()) < self:GetNWInt("distance") then
		cam.Start3D2D(pos+ang:Up()*3.3, ang, 0.035)
			draw.SimpleTextOutlined("Qurantimycin", "methFont", -25, -8, mainColor, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(25, 25, 25, 100));
