-- "addons\\rised_tech\\lua\\entities\\turret_box_combine\\cl_init.lua"
...
function ENT:Draw()
	...
	cam.Start3D2D(position, angle, 0.1)
		...
		draw.SimpleTextOutlined("Т у р е л ь   А л ь я н с а", "marske4" ,0,(k*25-30), Color(255,255,255,255), 1, 1, 0.5, Color(0,0,0,255))
