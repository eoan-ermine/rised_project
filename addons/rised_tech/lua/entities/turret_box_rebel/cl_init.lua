-- "addons\\rised_tech\\lua\\entities\\turret_box_rebel\\cl_init.lua"
...
function ENT:Draw()
	...
	cam.Start3D2D(position, angle, 0.1)
		...
		draw.SimpleTextOutlined("В з л о м а н н а я   Т у р е л ь", "marske4" ,0,(k*25-30), Color(255,255,255,255), 1, 1, 0.5, Color(0,0,0,255))
