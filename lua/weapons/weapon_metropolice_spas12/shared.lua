-- "lua\\weapons\\weapon_metropolice_spas12\\shared.lua"
...
if CLIENT then
language.Add("weapon_metropolice_spas12", "Metropolice SPAS-12")
killicon.Add( "weapon_metropolice_spas12", "effects/killicons/weapon_metropolice_spas12", color_white )

SWEP.PrintName = "SPAS-12 (no voice)"
SWEP.Slot = 3
SWEP.SlotPos = 4
SWEP.DrawAmmo = true
...
function SWEP:Holster()
	timer.Destroy( "ammo_add" )
	timer.Destroy( "reload_finish" )
	self:StopIdle()
	return true
end
