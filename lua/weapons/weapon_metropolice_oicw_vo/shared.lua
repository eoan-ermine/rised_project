-- "lua\\weapons\\weapon_metropolice_oicw_vo\\shared.lua"
...
if CLIENT then
language.Add("weapon_metropolice_oicw_vo", "Metropolice OICW")
killicon.Add( "weapon_metropolice_oicw_vo", "effects/killicons/weapon_metropolice_oicw", color_white )
