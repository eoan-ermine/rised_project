-- "lua\\weapons\\tfa_ins2_c7e_redux\\shared.lua"
...
SWEP.Manufacturer = "Colt Canada" --Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Author				= "NB" --Author Tooltip
SWEP.Contact				= "" --Contact Info Tooltip
SWEP.Purpose				= "why tho" --Purpose Tooltip
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_C7ERB.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2_C7ERB.2") -- This is the sound of the weapon, when silenced.
...
--Range Related
SWEP.Primary.Range = 590 * 48 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/c_nb_ins_c7e.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/w_nb_ins_c7erb.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-1.846, -3, -0.343)
SWEP.IronSightsAng = Vector(0.067, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-1.86, -2.303, -0.465)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-1.855, -2.6, -0.47)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-1.86, -2.303, -0.465)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-1.86, -2.303, -0.45)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_C79 = Vector(-1.856, -2.5, -0.82)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)

SWEP.IronSightsPos_PO4X = Vector(-1.808, -3.3, -0.09)
...
SWEP.Idle_Mode = TFA.Enum.IDLE_HYBRID --TFA.Enum.IDLE_DISABLED = no idle, TFA.Enum.IDLE_LUA = lua idle, TFA.Enum.IDLE_ANI = mdl idle, TFA.Enum.IDLE_BOTH = TFA.Enum.IDLE_ANI + TFA.Enum.IDLE_LUA
...
SWEP.VElements = {
	...
	["scope_po4x"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_po4x24.mdl", bone = "A_Optic", rel = "", pos = Vector(0, -0.005, -1.17), angle = Angle(90, 90, 0), size = Vector(0.661, 0.661, 0.661), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	["scope_po4x_lens"] = { type = "Model", model = "models/rtcircle.mdl", bone = "A_Optic", rel = "", pos = Vector(-0.04, 0.869, -5.041), angle = Angle(-90, 0, 0), size = Vector(0.173, 0.173, 0.173), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {}, active = false },
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_sec.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 90, 0), size = Vector(0.6, 0.6, 0.6), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = false, active = false },
	["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_foregrip_sec2.mdl", bone = "A_Foregrip", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 90, 0), size = Vector(0.485, 0.485, 0.485), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	["sights_folded"] = { type = "Model", model = "models/weapons/upgrades/a_carryhandle_c7e.mdl", bone = "A_Optic", rel = "", pos = Vector(-2, 0.884, -11.985), angle = Angle(90, 90, 0), size = Vector(1.07, 1.07, 1.07), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = true},
	["basegrip"] = { type = "Model", model = "models/weapons/upgrades/a_basegrip_c7e.mdl", bone = "A_Foregrip", rel = "", pos = Vector(0, -0.245, 0.159), angle = Angle(0, -90, 0), size = Vector(0.711, 0.711, 0.711), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_rail.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(-0.798, 0.012, -0.027), angle = Angle(0, 0, 90), size = Vector(0.947, 0.947, 0.947), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
...
SWEP.ScopeDistanceMin_C79 = 24
SWEP.ScopeDistanceRange_C79 = 24
...
SWEP.ScopeDistanceMin_2XRDS = 20
SWEP.ScopeDistanceRange_2XRDS = 20
