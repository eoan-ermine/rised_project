-- "lua\\weapons\\weapon_metropolice_usp_match_vo\\shared.lua"
...
if CLIENT then
language.Add("weapon_metropolice_usp_match_vo", "USP Match")
killicon.Add( "weapon_metropolice_usp_match_vo", "effects/killicons/weapon_metropolice_usp_match", color_white )
